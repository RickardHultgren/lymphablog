...
A blog about the programming language [LYMPHA](https://lympha.readthedocs.io/en/latest/). Two interpreters are being designed: an [on/line](http://rickardhultgren.github.io/lymphaonline/index) and an [off-line](https://gitlab.com/rickardhultgren/lympha-interpreter/-/tree/master/)<br><br>
